...
<div class="flex flex-col flex-wrap sm:flex-row">
	...
	<div
		class="shadow-lg rounded-xl w-full md:w-3/12 p-4 md:mr-2 bg-white dark:bg-gray-800 relative overflow-hidden mt-8"
	>
		<p class="text-gray-600  dark:text-white text-xl font-medium mb-6">Popular Investissors</p>
		<div class="grid grid-cols-3 gap-4">
			<div class="flex flex-col items-center">
				...
				<span class="text-gray-600 dark:text-gray-400 text-xs mt-2"> Enoch Ndika </span>
			</div>
			<div class="flex flex-col items-center">
				<div class="relative">
					<span class="block relative">
				...
				<span class="text-gray-600 dark:text-gray-400 text-xs mt-2"> Lionel Messi </span>
			</div>
			<div class="flex flex-col items-center">
				<div class="relative">
					<span class="block relative">
				...
				<span class="text-gray-600 dark:text-gray-400 text-xs mt-2"> Jonathan Ilunga </span>
			</div>
			<div class="flex flex-col items-center">
				<div class="relative">
					<span class="block relative">
				...
				<span class="text-gray-600 dark:text-gray-400 text-xs mt-2"> Maurice Lokumba </span>
			</div>
			<div class="flex flex-col items-center">
				<div class="relative">
					<span class="block relative">
				...
				<span class="text-gray-600 dark:text-gray-400 text-xs mt-2"> Cristiano Ronaldo </span>
			</div>
			<div class="flex flex-col items-center">
				<div class="relative">
					<span class="block relative">
				...
				<span class="text-gray-600 dark:text-gray-400 text-xs mt-2"> Dave Glad </span>
			</div>
		</div>
	</div>
	<div
	...
	<div
		class="shadow-lg rounded-xl w-full md:w-4/12 md:ml-4 mt-8 p-4 bg-white dark:bg-gray-800 relative overflow-hidden"
	>
